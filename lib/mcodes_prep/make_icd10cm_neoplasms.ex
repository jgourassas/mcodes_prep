defmodule McodesPrep.MakeIcd10cmNeoplasms do
  ...
  def set_neoplasm_xml_file do
    IO.gets("\t Location of ICD-10-CM INDEX XML file i.e: data/icd10cm_neoplasm_2022.xml  > ")
    |> String.trim()
  end
          ...
          cond do
            value = Map.get(elm, :term_level) ->
              if value == "1" do
                ...
                McodesPrep.Repo.insert(%McodesPrep.Icd10cmNeoplasms{
                  title: term_title,
                  main_term: terms_map
                })
              end
